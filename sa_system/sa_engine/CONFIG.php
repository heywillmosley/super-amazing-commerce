...
/**
 * Super Amazing Commerce Version
 *
 * What's New:
 * - Released to the public as GPL v2
 * - Improved security
 ...
 * Table Prefix
 */
	define('SYS_PREFIX', 'sa_');	

/** 
 * Set as Bootstrap library if standalone
 * @since 0.1 s9
 */
	if( substr( dirname (dirname (dirname(__FILE__) ) ), -22 ) == 'Super-Amazing-Commerce-Library' || substr( dirname (dirname (dirname(__FILE__) ) ), -22 ) == 'super-amazing-commerce-library' || substr( dirname (dirname (dirname(__FILE__) ) ), -11 ) == 'SA_Library' || substr( dirname (dirname (dirname(__FILE__) ) ), -11 ) == 'sac_library' )
		define( 'LIB', TRUE );
	else
		define( 'LIB', FALSE );
...
/** 
 * Set as Super Amazing Commerce if standalone
 * @since 0.1 s9
 */
 	if( !WP && !LIB )
		define( 'SA', TRUE );
...
if( LIB )
{
	if( substr( dirname (dirname (dirname(__FILE__) ) ), -22 ) == 'Super-Amazing-Commerce-Library' || substr( dirname (dirname (dirname(__FILE__) ) ), -22 ) == 'super-amazing-commerce-library' )
	{
		define( 'LIB_NAME', substr( dirname (dirname (dirname(__FILE__) ) ), -22 ) );	
	}
	
	elseif( substr( dirname (dirname (dirname(__FILE__) ) ), -11 ) == 'SA_Library' || substr( dirname (dirname (dirname(__FILE__) ) ), -11 ) == 'sac_library' )
	{
		define( 'LIB_NAME', substr( dirname (dirname (dirname(__FILE__) ) ), -11 ) );	
	}	
