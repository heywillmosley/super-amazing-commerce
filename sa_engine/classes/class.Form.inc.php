...
class Form
{
	 ...
	 * @return         void
	 */
		function __construct( $id = 'form-formula', $class = '', $method = 'POST', $action = '#', $role = 'form' )
		{
	 	...
	 	function addElement( $element )
		{
			...
			/* ##### ELEMENT TYPE ##### */
				...
				if( $type == 'text' || $type == 'textbox' || $type == 'password' || $type == 'email' )
				{
					...
					$element = "<div class='form-group'><input type='$type' name='$name' id='$name $id' placeholder='$placeholder' value='";
					...
					# Set the class
					$element .= "' class='$name $class form-control";
					
					# Add appropriate spacing if there's a caption
					if( !empty( $caption ) ) $element .= " ";
				...
				{
					# Begin creating the input
					$element = "<div class='form-group'><textarea type='$type' name='$name' id='$name $id' placeholder='$placeholder"; 
				...
				if( $type == 'submit' || $type == 'button' || $type == 'btn' )
				{
					...
					# Set the class
					$element .= "' class='$name btn btn-default $class form-control";
			...
			if( array_key_exists( $name, $errors ) )
			{
				...
				if( !empty( $caption ) )	
				$error_msg .= "<div class='caption mbs mtt'>&uarr; $caption</div>";
			...
			{
				if( !empty( $caption ) )
					$element .= "<div class='caption mbs mtt'>&uarr; $caption</div>";
				$element .= "</div>";
			}
