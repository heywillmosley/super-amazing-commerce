 ...
 */
	...
	{ ?>
		<!-- Load Stylesheets -->
        <link rel="stylesheet" href="<?php get_engine_css_url(); ?>styles.css" type="text/css" media="screen" />
        <style>
			@media print{
				.hide-for-print
				{
        ...
        <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Oxygen" type="text/css" media="screen" />
         ...
         <?php // Load Scripts; ?>
		<script src="<?php get_engine_js_url(); ?>vendor/custom.modernizr.js"></script>
 ...
 */
	function sa_footer()
	{ ?>
        <script src="<?php get_engine_js_url(); ?>vendor/jquery.min.js"></script>
        <script src="<?php get_engine_js_url(); ?>vendor/custom.bootstrap.min.js"></script>
		<script src="<?php get_engine_js_url(); ?>vendor/custom.foundation.min.js"></script>
		<script src="<?php get_engine_js_url(); ?>shadow.js"></script>
		<script>
		...
		<script src="<?php get_engine_js_url(); ?>vendor/jquery.smoothdivscroll-1.3-min.js" type="text/javascript"></script>
...
function app_header()
{
	...
	include_once( the_app_uri().'header.php');
...
function app_footer()
{
	...
	include_once( the_app_uri().'footer.php');
